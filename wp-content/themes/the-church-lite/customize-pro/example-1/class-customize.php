 ...
 * @access public
 */
final class the_church_lite_Example_1_Customize {
	...
	public function the_church_lite_sections( $manager ) {
		...
		$manager->register_section_type( 'the_church_lite_Example_1_Customize_Section_Pro' );

		// Register sections.
		$manager->add_section(
			new the_church_lite_Example_1_Customize_Section_Pro(
				$manager,
				'example_1',
				array(
					'title'    => esc_html__( 'Upgrade to Pro', 'the-church-lite' ),
					'pro_text' => esc_html__( 'Upgrade Now', 'the-church-lite' ),
					'pro_url'  => the_church_lite_protheme_url,
					'priority'   => 1,
				)
			)
		);
...
the_church_lite_Example_1_Customize::the_church_lite_get_instance();